...
public class ClickGuiModule extends Module {
   ...
   public ModeSetting theme = this.registerMode("Skin", Collections.singletonList("Clear"), "Clear", () -> false);
   ...
   public ColorSetting registerColor(
      String name, String configName, Supplier<Boolean> isVisible, boolean rainbow, boolean rainbowEnabled, boolean alphaEnabled, GSColor value
   ) {
