...
public class NameProtect extends Module {
   ...
   public String replaceName(String string) {
      if (string != null && this.isEnabled()) {
         ...
         return string.replace(username, this.name.getText())
            .replace(username.toLowerCase(), this.name.getText().toLowerCase())
            .replace(username.toUpperCase(), this.name.getText().toUpperCase());
      } else {
         return string;
      }
   }
