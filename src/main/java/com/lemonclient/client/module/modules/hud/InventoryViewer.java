...
public class InventoryViewer extends HUDModule {
   ...
   private class InventoryViewerComponent extends HUDComponent {
      ...
      public void render(Context context) {
         ...
         Color bgcolor = new GSColor(InventoryViewer.this.fillColor.getValue(), InventoryViewer.this.fill.getValue());
         context.getInterface().fillRect(context.getRect(), bgcolor, bgcolor, bgcolor, bgcolor);
         Color color = new GSColor(InventoryViewer.this.outlineColor.getValue(), InventoryViewer.this.outline.getValue());
