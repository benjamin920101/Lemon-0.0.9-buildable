...
public class Notifications extends Module {
   ...
   public DoubleSetting xSpeed = this.registerDouble("Animation XSpeed", 0.1, 0.01, 0.5);
   public DoubleSetting ySpeed = this.registerDouble("Animation YSpeed", 0.1, 0.01, 5.0);
