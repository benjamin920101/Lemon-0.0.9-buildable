...
public class ReflectionUtil {
   ...
   public static Field getField(Class<?> clazz, String... mappings) throws NoSuchFieldException {
      ...
      throw new NoSuchFieldException("No Such field: " + clazz.getName() + "-> " + Arrays.toString((Object[])mappings));
   }
   ...
   public static Method getMethodNoParameters(Class<?> clazz, String... mappings) {
      ...
      throw new RuntimeException("Couldn't find: " + Arrays.toString((Object[])mappings));
   }
