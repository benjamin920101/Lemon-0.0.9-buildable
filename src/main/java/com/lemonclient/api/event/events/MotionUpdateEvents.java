...
public class MotionUpdateEvents extends LemonClientEvent {
   ...
   public MotionUpdateEvents(double x, double y, double z, float rotationYaw, float rotationPitch, boolean onGround) {
      this.x = x;
      this.y = y;
      this.z = z;
   ...
   public static class Riding extends MotionUpdateEvents {
      ...
      public Riding(MotionUpdateEvents.Riding event) {
         this(
            event.getX(),
            event.getY(),
            event.getZ(),
